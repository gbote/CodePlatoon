...
class SwimRecordTestCase(TestCase):
    ...
    def test_05_valid_stroke(self):  # sourcery skip: raise-specific-error
    ...
    def test_06_valid_distance(self):  # sourcery skip: raise-specific-error
    ...
    def test_07_no_future_records(self):  # sourcery skip: raise-specific-error
