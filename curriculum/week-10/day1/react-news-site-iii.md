...
Let's add some functionality, an add in a `Something` component that will be created/updated/destroyed inside of our application:
  ...
  render() {
    return (
      <div className="App">
        ...
        {
          this.state.exists 
            ? <Something value={this.state.someValue} /> 
            : null
        }
      </div>
    );
