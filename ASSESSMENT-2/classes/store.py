...
class Store: 
    ...
    def add_customer(self):
        ...
        if customer_data is None: return #user quit out of menu
        ...
        while serving:
            ...
            if movie == 'Q': return
                ...
                if customer.allowed_rating(movie.rating):
                    ...
                    movie.rented()
                    serving = input('\nDoes the customer have more videos to rent out?\n\nPress Y to rent another video: ') == 'Y' if customer.can_rent_more() else False
                else: 
    ...
    def change_customer_account(self):
        ...
        if account in ['sx', 'sf'] and customer.num_rentals > 1:
            ...
            return
        elif account in ['sf', 'pf'] and customer.has_ratedR(self.inventory):
    ...
    def add_videos(self):
        ...
        if video_data is None: return #user quit out of menu
    ...
    def get_customer(self):  # sourcery skip: avoid-builtin-shadow
